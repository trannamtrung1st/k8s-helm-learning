...
- **Helm (preferred):** **`./scripts/helm-apply.sh`** installs the full stack from **`devops/workbench-umbrella`** (see **`devops/README.md`**). RabbitMQ and Redis config live under each chart’s **`files/`** directory.
